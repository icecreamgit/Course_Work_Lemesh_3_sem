...
def Crossroads(mode, params, YObject, HEObject, KLObject, BHObject, ValdSavObject, nparams):
    if mode == 0:
...
def Main():
    ...
    Crossroads(0, params, YObject, HEObject, KLObject, BHObject, ValdSavObject, nparams)
